...
- Prisma CLI migrations use `MIGRATION_DATABASE_URL` separately.
...
- Each backup is a PostgreSQL custom archive, validated with `pg_restore
  --list`, accompanied by SHA-256 metadata, and restricted to the file owner.
