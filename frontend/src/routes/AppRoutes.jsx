...
import InvoiceSettingsPage from '../pages/Invoices/Settings'
  ...
  return (
    <Routes>
      ...
      <Route element={<MainLayout />}>
        ...
        <Route path="/bookings/:id/collections" element={<BookingCollectionPage />} />
        ...
        <Route path="/vehicles" element={<Navigate to="/vendors" replace />} />
        ...
        <Route path="/accounts" element={<Navigate to="/accounts/manager-ledger" replace />} />
        <Route path="/accounts/manager-ledger" element={<ManagerLedgerPage />} />
        <Route path="/accounts/manager-ledger/release" element={<ManagerLedgerFormPage />} />
        <Route path="/accounts/manager-ledger/:managerName" element={<ManagerLedgerDetailPage />} />
        <Route path="/accounts/transactions" element={<TransactionsPage />} />
        <Route path="/accounts/expense-entry" element={<Navigate to="/accounts/transactions" replace />} />
        <Route path="/accounts/booking-cash-deposit" element={<BookingCashDepositPage />} />
        <Route path="/accounts/daily-closing" element={<DailyClosingPage />} />
        <Route path="/accounts/audit-verification" element={<AuditVerificationPage />} />
        <Route path="/accounts/reconciliation" element={<Navigate to="/accounts/audit-verification" replace />} />
        <Route path="/expenses" element={<ExpensesPage />} />
        <Route path="/reports" element={<ReportsPage />} />
        <Route path="/settings" element={<SettingsPage />} />
        <Route path="/settings/gst-registrations" element={<GSTRegistrationsPage />} />
        <Route path="/settings/gst-registrations/new" element={<GSTRegistrationsPage />} />
        <Route path="/settings/gst-registrations/:registrationId" element={<GSTRegistrationsPage />} />
        <Route path="/settings/gst-registrations/:registrationId/edit" element={<GSTRegistrationsPage />} />
