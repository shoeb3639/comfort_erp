...
const pageMeta = {
  "/platform/dashboard": {
    ...
    description:
      "Monitor tenants, subscriptions, trials, revenue, and support activity.",
  },
  "/platform/tenants": {
    eyebrow: "Tenant management",
    title: "Tenants",
    description:
      "Create, activate, suspend, and monitor car rental company accounts.",
  },
  ...
  "/platform/subscriptions": {
    ...
    description:
      "Track subscription status, expiry, grace period, and payment state.",
  },
  "/platform/payments": {
  ...
  "/platform/audit-logs": {
    ...
    description:
      "Review platform-level tenant, subscription, billing, and access actions.",
  },
};
