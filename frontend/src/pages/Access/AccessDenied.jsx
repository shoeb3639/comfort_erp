  ...
  return (
    <div className="rounded-2xl border border-rose-200 bg-white p-8 shadow-sm">
      ...
      <p className="mt-3 max-w-2xl text-sm text-slate-600">
        This screen is ready for future permission-based route guards. Access
        should be checked with permission keys such as
        <code className="mx-1 rounded bg-slate-100 px-1.5 py-0.5 text-xs font-semibold">
          booking.view
        </code>
        or
        <code className="mx-1 rounded bg-slate-100 px-1.5 py-0.5 text-xs font-semibold">
